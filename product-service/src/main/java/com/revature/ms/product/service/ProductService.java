package com.revature.ms.product.service;
...
import com.revature.ms.product.repository.ProductRepository;
...
public class ProductService {
    ...
    public ProductResponse createProduct(ProductRequest productRequest) {
		  ...
		  .description(productRequest.description()) .skuCode(productRequest.skuCode())
